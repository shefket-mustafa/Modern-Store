...
import { registerSchema, type RegisterSchemaType } from '../lib/zod/registerSchema';
...
export default function Register() {
  ...
  const handleRegister = async(data: RegisterSchemaType) =>{
    ...
    try{
      ...
      if(!res.ok) {
        setError("root", {message: "Register failed - Internal issue"})
      }
      ...
      >
        ...
        {errors.root && (
         ...
         <div className="mb-5">
          ...
          />
          {errors.username && (
            <p className="text-red-500 text-sm mb-3 bg-red-50 p-2 rounded-lg text-center">{errors.username.message}</p>
          )}
        </div>
        ...
        <div className="mb-5">
          ...
          />
           {errors.email && (
            <p className="text-red-500 text-sm mb-3 bg-red-50 p-2 rounded-lg text-center">{errors.email.message}</p>
          )}
        </div>
        ...
        <div className="mb-6">
          ...
          />
           {errors.password && (
            <p className="text-red-500 text-sm mb-3 bg-red-50 p-2 rounded-lg text-center">{errors.password.message}</p>
          )}
        </div>
          ...
          />
           {errors.confirmPassword && (
            <p className="text-red-500 text-sm mb-3 bg-red-50 p-2 rounded-lg text-center">{errors.confirmPassword.message}</p>
          )}
        </div>
